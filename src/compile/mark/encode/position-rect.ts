...
import {ArcPositionChannel, isArcPositionChannel, PositionChannel, X, X2, Y2} from '../../../channel';
import {
  getBand,
...
function getBinSpacing(channel: PositionChannel | ArcPositionChannel, spacing: number, reverse: boolean | SignalRef) {
  if (isArcPositionChannel(channel)) {
    return 0;
  }
